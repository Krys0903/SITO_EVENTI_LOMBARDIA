         ...
         <div class="signin">
            <div class="content">
               ...
               <form name="menu" class="formRoba" method="post">
                  ...
                  <div class="links"> 
                     <u style="color:green"><a href="registrazione.php">VAI ALLA REGISTRAZIONE</a></u>
                  </div>
                  <div class="inputBox"> 
         ...
         if(isset($_POST["send"])) {
          ...
          if ($result->num_rows > 0) {
              ...
              if ($result->num_rows > 0) {
                ...
                echo '<script>mostraAlert("successo", "LOGGATO CON SUCCESSO")</script>';
              }else{
                echo '<script>mostraAlert("errore", "PASSWORD ERRATA")</script>';
              }
          }else{
            echo '<script>mostraAlert("errore", "QUESTA EMAIL NON È REGISTRATA")</script>';
          }
